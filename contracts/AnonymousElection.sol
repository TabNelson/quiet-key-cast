// fix: correct encrypted vote sum calculation  // improve error messages
...
contract AnonymousElection is SepoliaConfig {
    ...
    /// @dev Users encrypt their candidate choice (1 for candidate A, 2 for candidate B, etc.)
    ///      The vote is homomorphically added to the encrypted sum without decryption
    function vote(
        uint256 _electionId,
